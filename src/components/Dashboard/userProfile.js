  ...
  return (
    <section className="flex items-center mb-16 w-[50%] mx-auto ">
      ...
      <div className='flex  items-center gap-7'>
        ...
        <h2 className="text-xl">Shiva</h2>
        <p className="text-[rgba(130,130,130)] line-clamp-2">Hey I am the Founder of Zolvit and a Explorer Vakilsearch.pvt.ltd www.Shiva.com</p>
        </div>

  ...
  return (
    <section className="flex items-center mb-16 w-[50%] mx-auto ">
      ...
      <div className='flex  items-center gap-7'>
        ...
        <p className="text-[rgba(130,130,130)] line-clamp-2">Hey I am the Founder of Arevei and a Explorer Arevei.pvt.Ltd <a href="https://www.arevei.com">www.arevei.com</a></p>
        </div>
